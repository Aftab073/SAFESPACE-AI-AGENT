...
from database import (
    ...
    clear_user_chat_history  # ← Added this import
)
...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:8501",
        "https://safespace1.streamlit.app"  # ← Removed trailing slash
    ],
...
async def clear_chat_history_endpoint(current_user: dict = Depends(get_current_user)):
